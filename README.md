...
- 進捗ダッシュボード: https://aichirofunakoshi.github.io/Bridge-TTS-Codex-/dashboard.html
...
- **ユーザー辞書**: 施設名・人名などの固有名詞（よみ／表記／英語表記）を端末内に登録。音声認識が別語に書き起こす固有名詞は「誤認識される表記」の登録で認識段階から決定的に置換
