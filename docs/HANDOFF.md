...
- **最新リリース**: **v2.6.1**（配信済み）。v2.5.0=翻訳モード/ユーザー辞書/デバウンス自動適用、v2.6.0=設定エクスポート・インポート/評価ハーネス、v2.6.1=プロンプト品質修正（評価50ケース88%→**100%**・致命的誤訳0件=KPI-3達成）
- **未リリースの改良**: なし
...
- **次にやること**: v2.7「会話体験の完成」= F12レイテンシ計測の実装から（設計は PROJECT_GOALS §6「v2.7 レイテンシ設計」の実装順1〜5）
